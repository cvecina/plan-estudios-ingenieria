...
// Configurar la página como pública (sin layout)
definePageMeta({
  layout: false,
  auth: false
})
...
// Configurar SEO
useHead({
  title: 'Registro - Repasa+',
  meta: [
    { name: 'description', content: 'Crea tu cuenta en Repasa+ para gestionar tus estudios universitarios' }
  ]
})
